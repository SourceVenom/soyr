...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 𓆩الــسيد𓆪 𖠛🇷🇺 ](t.me/K_o_c_1)   \n"
    "**-** قناة السورس **⪼ [𐇮 فينوم ](t.me/K_o_c_3)   "
]
...
DevJoker = [705475246]
#تضل تخمط من عمك فينوم  ؟ الى اين يستمُر الفشل ياغُلام
...
async def Hussein(event):
    ...
    await event.edit(f'**ها هيَ الفيزات تم استخراجها من قبل سورس فينوم ** \n@K_o_c_3:\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ المعلومات للفيزا تم استخراجها من قبل سورس فينوم ** \n@K_o_c_3\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ البطاقة تم فحصها من قبل سورس فينوم ** \n@K_o_c_3\n {response.text}')
