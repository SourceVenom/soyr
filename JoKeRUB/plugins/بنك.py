...
- مثال: .انشاء حساب الرافدين او فينوم الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "فينوم الاسلامي":
        bankn = "مصرف فينوم الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "فينوم الاسلامي":
